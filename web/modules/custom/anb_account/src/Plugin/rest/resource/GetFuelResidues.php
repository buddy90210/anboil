...
/**
 * Provides a resource to get fuel residues for current user.
 *
 * @RestResource(
 *   id = "get_fuel_residues",
 *   label = @Translation("Get fuel residues."),
 *   uri_paths = {
 *     "canonical" = "/api/v1/get-fuel-residues"
 *   }
 * )
 */
class GetFuelResidues extends ResourceBase {
  ...
  public function get() {
    ...
    // Send API request.
    $request_url = $api_url . '/tank_farm_anb_copy/hs/exchange_/fuel_storage?inn=' . $account_identifier . '&token=' . $api_token;
